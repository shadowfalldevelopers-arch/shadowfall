...
const enemy = new Fighter1({
  ...
  offset: { x: 215, y: 100 },
  sprites: {
    idle: { imageSrc: './img/kenji1/Idle.png', framesMax: 8 },
    run: { imageSrc: './img/kenji1/Run.png', framesMax: 8 },
    jump: { imageSrc: './img/kenji1/Jump.jpg', framesMax: 100000 },
    fall: { imageSrc: './img/kenji1/Fall.jpg', framesMax: 100000 },
    attack1: { imageSrc: './img/kenji1/Attack.png', framesMax: 8 },
    takeHit: { imageSrc: './img/kenji1/Take hit.png', framesMax: 4 },
...
function animate() {
  ...
  if (gamePaused) return  // Stop updates when paused
...
window.addEventListener('keydown', (event) => {
  ...
  if (event.key === 'o') {
    if (gamePaused) {
      gamePaused = false
      // Do NOT call animate() again! The loop will continue automatically
    }
    return
  }
